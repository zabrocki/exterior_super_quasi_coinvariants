...
The set
$${\mathcal D}_n =\big\{ \Delta_C: \text{ $C=(C_1,C_2,\ldots C_k)$  non-crossing and $0\le k\le \lfloor \frac{n}{2}\rfloor$}\big\},
$$
...
$$  
And this shows that $\Delta_C\in EQH_n $ for all non-crossing $C$.
\end{proof}
