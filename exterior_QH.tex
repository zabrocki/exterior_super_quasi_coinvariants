...
Furthermore, using Proposition~\ref{prop:leading}, it is linearly independent. We only need to show that
it $\mathbb Q$--spans the ideal.

[...]\nantel{detailes to be filled in later}
