...
\mike{we need the rest of the proof and some motivation here}
...
For the reverse inclusion, take an element which is not in the
...
\bibitem{Algebraic combinatorics and coinvariant spaces}.
CRC Press, 2009.
...
\bibitem{DLM} Desrosiers, Patrick, Luc Lapointe, and Pierre Mathieu.
\textit{Classical symmetric functions in superspace}.
Journal of Algebraic Combinatorics 24.2 (2006): 209--238.

\bibitem{DLM2} Desrosiers, P., Lapointe, L. and Mathieu, P., 2003.
\textit{Jack polynomials in superspace}.
Communications in mathematical physics, 242(1), pp.331--360.
...
\bibitem{GW} Garsia, Adriano M., and Nolan Wallach.
