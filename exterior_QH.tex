...
$(\theta_{i_{r_1}}-\theta_{j_{r_1}})(\theta_{i_{r_2}}-\theta_{j_{r_2}})$ in front  performing $(r_1-1)+(r_2-2)$ commutations, we have 
  ...
  The only comparison we do not know is  $ j_{r_1}$ versus  $i_{r_2}$. If $ j_{r_1}<i_{r_2}$ we have 
  $$\sum_{i\in C_{r_1} \atop j\in C_{r_2}} \pm  \partial_{\theta_j}\partial_{\theta_i}\Delta_T 
  = (-1)^{r_1+r_2-1}\big(    \big)
  (\theta_{i_{r_1}}-\theta_{j_{r_1}})(\theta_{i_{r_2}}-\theta_{j_{r_2}})q
  $$

  \textcolor{red}{Nantel shall write more of the  proof later}
