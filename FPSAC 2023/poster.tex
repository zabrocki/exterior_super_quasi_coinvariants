% Mike's comments.
% Reduce notation: the person coming into your discussion half way through will not follow.  This is not a paper.
% I notice "R_n" and "I_n", "EQH" and "EQC"
% where a formula is a definition put a :=
% Don't use specialized vocabulary if possible. "coinvariant" is not
% I like the "history" section
% more pictures (even if they were not in the paper!)
...
\begin{multicols}{3}
  \begin{postersection}[Overview \emoji{shipping-fast}]
      ...
      The short answer: there is a basis of $\{0,1\}$-ballot sequences similar to the
      ...
      \begin{itemize}
        ...
        \item Invariant polynomials are called \emph{quasisymmetric}. A basis consists of
          \begin{align*}
            ...
            &= \theta_{1}\theta_{2}\theta_{3}
          \end{align*}
        \item The quasisymmetric invariant ideal is $\langle \mathrm{QSym}_{n}^{+} \rangle = \langle F_{1}, \dots, F_{n} \rangle$.
      \end{itemize}
    \end{postersection}
