...
\begin{multicols}{3}
  \begin{postersection}[Overview \emoji{shipping-fast}]
    ...
    \begin{postersection}[Harmonics]
      ...
      But they are not linearly independent:
      \[
    ...
    \begin{postersection}[Ballot sequences and non-crossing pairing]
      ...
      Interpret a $0$ as a North step and an $1$ as an East step:
      \begin{center}
        \begin{tikzpicture}
          \begin{scope}[shift={(-5,0)}]
            \draw[dotted] (0,0) -- (8,8);
