...
\begin{multicols}{3}
  \begin{postersection}[Overview \emoji{shipping-fast}]
    ...
    \begin{postersection}[The Setup]
      Motivated by recent development in coinvariant theory involving Fermionic (anticommuting) variables, we study the $\mathrm{QSym}$ coinvariant spaces of the exterior algebra
      \[
