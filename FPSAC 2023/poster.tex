...
\usepackage{graphicx, tikz, qrcode, fontawesome5}
...
\newcommand{\thesectioncolour}{ForestGreen!20}
\newcommand{\thethmcolour}{\thetitlecolour}
...
{% before 
  \begin{mdframed}[hidealllines=true]
    \IfNoValueTF{#1}{}{
      \begin{mdframed}[backgroundcolor=\thesectioncolour,hidealllines=true]
        \centering
        {\color{black} \Large #1}
      \end{mdframed}
    }
...
\begin{multicols}{3}
  \begin{postersection}[Overview \emoji{shipping-fast}]
    ...
    \begin{postersection}[The History \emoji{history}]
      ...
      \begin{center}
        ...
        \begin{tikzpicture}
          ...
          \node[above right] at (2,0) {\footnotesize $G_{0020021} \notin \langle \mathrm{QSym}_{n}^{+} \rangle$.};
          \end{scope}
          ...
          \begin{scope}[shift={(5,0)}]
            ...
            \node[above right] at (2,0) {\footnotesize $G_{000150001} \in \langle \mathrm{QSym}_{n}^{+} \rangle$.};
          \end{scope}
    ...
    \begin{postersection}[The Setup]
      ...
      \begin{itemize}
        ...
        \item Invariant polynomials are called \emph{quasisymmetric}. A basis consists of
          ...
          %   &=\sum_{\substack{A \subseteq [n]\\|A|=k}} \theta_{A}, \quad k = 1,\dots,n. \\
          % \end{align*}
          % In $\mathbb{Q}[\theta_{1}, \theta_{2}, \theta_{3}]$,
          % \[
          %   F_{1} = \theta_{1} + \theta_{2} + \theta_{3},\quad
          %   F_{11} = \theta_{1}\theta_{2} + \theta_{1}\theta_{3} + \theta_{2}\theta_{3},\quad
          %   F_{111} = \theta_{1}\theta_{2}\theta_{3}
          % \]
    ...
    \begin{postersection}[Detour to symmetric invariants]
      ...
      \begin{thm}
      The exterior algebra $\mathbb{Q}[\theta_{1}, \dots, \theta_{n}]$ is free over its \emph{symmetric} polynomials.
      \end{thm}
    ...
    \begin{postersection}[The structure of $\langle \mathrm{QSym}_{n}^{+} \rangle$]
      ...
      \begin{thm}
      The algebra $\mathrm{QSym}_{n} = \mathbb{Q}[F_{1}, \dots, F_{1^{n}}]$ is commutative and
      \[
        F_{1^{r}}F_{1^{s}} = 
        \begin{cases}
          \displaystyle
    ...
    \begin{postersection}[Ballot sequences and non-crossing pairing]
      ...
      \begin{thm}
        $\{ \Delta_{C(\alpha)} : \alpha \text{ is a ballot sequence } \}$ is linearly independent in $EQH_{n}$.
      \end{thm}
    ...
    \begin{postersection}[A linear basis of $\mathbb{Q} {[} \theta_1, \ldots, \theta_n {]}$ indexed by $\{0,1\}$-sequences]
      ...
      \begin{itemize}
        \item Indexed by a non-ballot sequence:
          ...
          &= \theta_{2} \theta_{4} \theta_{5} + \theta_{2} \theta_{4} \theta_{6} + \theta_{2} \theta_{5} \theta_{6} + 2 \theta_{3} \theta_{4} \theta_{5} + 2 \theta_{3} \theta_{4} \theta_{6} + 2 \theta_{3} \theta_{5} \theta_{6} + \theta_{4} \theta_{5} \theta_{6}.
          \end{align*}
    ...
    \begin{postersection}[Acknowledgement]
      We acknowledge the support of the Natural Sciences and Engineering Research Council of Canada (NSERC) and York University, Canada.
    \end{postersection}
